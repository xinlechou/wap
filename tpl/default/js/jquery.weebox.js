    ...
    var weebox = function(content, options) {
        ...
        this.initBox = function() {
            ...
            self.dh = $(html).appendTo('body').hide().css({
                position: 'absolute',
                //overflow: 'hidden',//弹框右上角需要有个overflow的叉子显示出来
...
//		}	
        ...
        this.setElementPosition = function() {
            ...
            //设置为居中；为解决弹框被虚拟键盘遮挡的问题，position=element,trigger可设置为#body
            var left = trigger.offset().left+(($(window).width() - self.dh.width())/2);
